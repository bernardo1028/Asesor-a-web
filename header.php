<meta name="viewport" content="width=device-width, initial-scale=1.0">
 ...
 <body>
 	<header>
        <img src="img/leer.png" class="foto1"  alt="foto1" width="50" height="50" style="float: left">
 		<h1 class="titulo">Red Asesorias</h1>
        
 		<form action="buscar.php" method="get" id="buscar">

 			<input type="text" name="busqueda" placeholder="Buscar asesor" font-family="Comic Sans MS">
